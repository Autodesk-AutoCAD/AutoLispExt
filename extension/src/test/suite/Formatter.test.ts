...
import { readFile2TextDocument } from '../suite/helper';
...
suite("Lisp Formatter Tests", function () {
	...
	test("Lisp Formatter Test case 1", async function () {
		//Basic test case
		let i = 1;
		try {
			const [source, output, baseline] = getFileName(i);
			const doc = await readFile2TextDocument(source);
	...
	test("Lisp Formatter Test case 2", async function () {
	...
	test("Lisp Formatter Test case 3", async function () {
	...
	test("Lisp Formatter Test case 4", async function () {
	...
	test("Lisp Formatter Test case 6", async function () {
	...
	test("Lisp Formatter Test case 8", async function () {
		...
		try {
			const [source, output, baseline] = getFileName(i);
			let doc = await readFile2TextDocument(source);
			// set as wide single column format
			await setLongListFormat('Single Column');
			let fmt = LispFormatter.format(doc, null);
			comparefileSync(i, output, fmt, baseline);
	...
	test("Lisp Formatter Test case 9", async function () {
	...
	test("Lisp Formatter Test case 10", async function () {
	...
	test("Lisp Formatter Test case 17", async function () {
	  ...
	  test("Lisp Formatter Test case 18", async function () {
	  ...
	  test("Lisp Formatter Test case 19", async function () {
