...
// This AST Object is a legacy object almost entirely used for formatting purposes
// Use the Sexpression when you need associated tooling that can preserve whitespace
// In all other cases, the LispContainer object has much better analytical tooling
...
export class Sexpression extends LispAtom {
    ...
    // b. Assemable the astObjects to expected format
    //
